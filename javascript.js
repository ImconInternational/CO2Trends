...
function initDifferentCO2Popups(){
	...
	$$("#co2TalkToOVGPopup").on("popup:open",function(){
		
	});
	
	
	$$("#sensorLocationPopup").on("popup:open",function(){
		loadGoogleMaps("googleMaps",gomaCoordinates,function(){
								//console.log("Cool!");
								presentCoordinatesOnMaps(differentCoordinates,googleMapsObj,function(){console.log("Wonderfu!")});
